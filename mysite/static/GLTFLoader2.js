...
/**
 * THREE.Materials Emissive Strength Extension
 *
...
/**
 * Iridescence THREE.Materials Extension
 *
...
/**
 * Sheen THREE.Materials Extension
 *
...
/**
 * THREE.Materials Volume Extension
 *
...
/**
 * THREE.Materials specular Extension
 *
		...
		if ( bufferView.extensions && bufferView.extensions[ this.name ] ) {
			...
			return buffer.then( function ( res ) {
				...
				if ( decoder.decodeGltfBufferAsync ) {
					...
					// Support for THREE.MeshoptDecoder 0.18 or earlier, without decodeGltfBufferAsync
...
class GLTFMeshGpuInstancing {
	...
	createNodeMesh( nodeIndex ) {
		...
		// No THREE.Points or THREE.Lines + Instancing support yet
...
class GLTFParser {
	 ...
	 * THREE.Textures) can be reused directly and are not marked here.
	 *
